...
<body>
	...
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong class="icon-reorder"> 在校学生历史打卡总记录</strong>
		</div>
				...
				<table class="fl-table">
					...
					<tr>
						<td colspan="8"><div class="pagelist">
								<a href="ReportHistoryServlet?pageNum=${InPageInfo.pageNum+1}">下一页</a>
								<a href="ReportHistoryServlet?pageNum=${InPageInfo.pages}">尾页</a>
							</div></td>
					</tr>
					<!--中间页  -->
					<%
					...
					<tr>
						<td colspan="8"><div class="pagelist">
								<a href="ReportHistoryServlet?pageNum=${InPageInfo.pageNum-1}">上一页</a>
								<a href="ReportHistoryServlet?pageNum=${InPageInfo.pageNum+1}">下一页</a>
								<a href="ReportHistoryServlet?pageNum=${InPageInfo.pages}">尾页</a>
							</div></td>
					</tr>
					...
					<tr>
						<td colspan="8"><div class="pagelist">
								<a href="ReportHistoryServlet?pageNum=1">首页</a>
							</div></td>
					</tr>
					<!-- 尾页，且不是首页 -->
					<%
	...
	<div class="panel admin-panel margin-top">
		<div class="panel-head" id="add">
			<strong><span class="icon-reorder"></span> 非在校学生历史打卡总记录</strong>
		</div>
		<div class="body-content">
			<!--start form  -->
			<form method="post" action="">
				<table class="fl-table">
					...
					<tr>
						<td colspan="10"><div class="pagelist">
								<a href="ReportHistoryServlet?pageNum2=${OuPageInfo.pageNum+1}">下一页</a>
								<a href="ReportHistoryServlet?pageNum2=${OuPageInfo.pages}">尾页</a>
							</div></td>
					</tr>
					<!--中间页  -->
					<%
					...
					<tr>
						<td colspan="10"><div class="pagelist">
								<a href="ReportHistoryServlet?pageNum2=${OuPageInfo.pageNum-1}">上一页</a>
								<a href="ReportHistoryServlet?pageNum2=${OuPageInfo.pageNum+1}">下一页</a>
								<a href="ReportHistoryServlet?pageNum2=${OuPageInfo.pages}">尾页</a>
							</div></td>
					</tr>
					...
					<tr>
						<td colspan="10"><div class="pagelist">
								<a href="ReportHistoryServlet?pageNum2=1">首页</a>
							</div></td>
					</tr>
					<!-- 尾页，且不是首页 -->
					<%
